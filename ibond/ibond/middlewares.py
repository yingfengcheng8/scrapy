...
class IbondDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
...
class SwitchProxy(object):
    def __init__(self):
        # 代理隧道验证信息
        self.proxyUser = "H5T6F685I08BFL0D"
        self.proxyPass = "F4BB539C95FD7454"
...
class SwitchUA(UserAgentMiddleware):
    def process_request(self, request, spider):
